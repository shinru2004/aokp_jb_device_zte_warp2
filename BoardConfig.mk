...
BOARD_BLUEDROID_VENDOR_CONF := device/zte/warp2/bluetooth/vnd_4330.txt
BUILD_EXTRA_BT_TOOLS := true
BOARD_HAVE_SAMSUNG_BLUETOOTH := true
TARGET_CUSTOM_BLUEDROID := true
...
ADDITIONAL_DEFAULT_PROPERTIES += persist.sys.usb.config=mass_storage,adb,mtp
